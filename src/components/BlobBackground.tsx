...
export function BlobBackground({ variant = "subtle" }: BlobBackgroundProps) {
    ...
    return (
      <div className="absolute inset-0 overflow-hidden">
        <div
          ...
          style={{ background: "var(--color-violet-2)" }}
        />
        <div
          className="blob blob-float w-64 h-64 top-1/3 -right-20"
          style={{ background: "var(--color-pink)", animationDelay: "2s" }}
        />
        <div
          className="blob blob-float w-56 h-56 bottom-10 -left-10"
          style={{ background: "var(--color-amber)", animationDelay: "4s" }}
        />
      </div>
    );
  }
  ...
  return (
    <div className="absolute inset-0 overflow-hidden">
      <div
        className="blob w-56 h-56 -top-16 -right-16 opacity-30"
        style={{ background: "var(--color-violet-2)" }}
      />
      <div
